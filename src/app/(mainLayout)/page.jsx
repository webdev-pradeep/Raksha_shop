...
const HomePage = () => {
  ...
  return (
    <>
      <div>
        <div className="pt-5 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 ">
      ...
      {loading && (
        <div className="flex items-center justify-center bg-amber-300 fixed inset-0 z-10 h-screen w-full ">
          <div className="relative">
            <div className="h-24 w-24 rounded-full text-5xl text-center mt-5 ">
              𝓡𝓟
            </div>
