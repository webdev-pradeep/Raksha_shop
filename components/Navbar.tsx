...
const Navbar = () => {
  return (
    <>
      <header className=' md:w-[100%] md:h-15  md:pr-35 md:text-white font-serif bg-[#779792]/70 md:flex md:justify-between md:items-center h-14 flex justify-between items-center fixed top-0 right-0 left-0'> 
      <Link href={"#"} className='md:text-2xl font-semibold md:pl-20 text-xl text-black p-2'>HALSUISEOO </Link>
